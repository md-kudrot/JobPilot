...
export const metadata: Metadata = {
  ...
  description:
    'Build your career profile so JobPilot AI can recommend jobs matched to your skills and preferences.',
};
    ...
    <div className="bg-[#0b1326] text-[#dae2fd] min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-32 pb-16 px-6 max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-16">
          <h1 className="text-[36px] leading-[44px] md:text-[48px] md:leading-[56px] tracking-[-0.04em] font-bold text-[#dae2fd] mb-1">
            Your Career Profile
          </h1>
