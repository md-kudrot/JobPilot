...
export default function Footer() {
    return (
        <footer className="bg-[#060e20] text-[#dae2fd] border-t border-[#ffffff]/5">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10 w-[80%] py-16 max-w-container-max mx-auto">
                <div className="space-y-6">
                    <div className="text-[24px] leading-[32px] tracking-[-0.02em] font-black text-[#c0c1ff]">
                        JobPilot AI
                    </div>
                    <p className="text-[14px] leading-[20px] tracking-[0em] font-normal text-[#c7c4d7]">
                        The intelligent command center for the modern job seeker.
                    </p>
                </div>
                <div>
                    ...
                    <ul className="space-y-3">
                        <li>
                            <a
                                className="text-[14px] leading-[20px] tracking-[0em] font-normal text-[#c7c4d7] hover:text-[#c0c1ff] transition-colors"
                                href="#"
                            >
                                About
                            </a>
                ...
                <div className="space-y-6">
                    <div className="text-[11px] leading-[16px] tracking-[0.05em] font-bold uppercase">
