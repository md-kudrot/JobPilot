...
export default function JobsHero() {
  return (
    <section className="space-y-6">
      ...
      <div className="glass-card ai-border-animate rounded-[20px] p-3 flex flex-col md:flex-row gap-3 items-center">
        ...
        <button className="w-full md:w-auto bg-[#c0c1ff] text-[#0d0096] text-[12px] leading-[16px] tracking-[0.02em] font-bold px-16 py-3 rounded-xl hover:opacity-90 active:scale-95 transition-all whitespace-nowrap">
          Search Jobs
        </button>
      </div>
    </section>
