    ...
    <section className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-[#0b1326] overflow-y-auto">
      <div className="w-full max-w-[440px] space-y-8 py-8">
        ...
        <div className="text-center lg:text-left space-y-3">
          ...
          <h3 className="text-[24px] leading-[32px] tracking-[-0.02em] font-semibold text-[#dae2fd]">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          {!isLogin && (
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <label className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c7c4d7] ml-1" htmlFor="firstName">
                  First Name
                </label>
              ...
              <div className="space-y-1">
                <label className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c7c4d7] ml-1" htmlFor="lastName">
                  Last Name
                </label>
                <div className="relative group">
                  <Person className="absolute left-4 top-1/2 -translate-y-1/2 text-[#c7c4d7] group-focus-within:text-[#c0c1ff] transition-colors w-5 h-5" />
          ...
          {/* Email Input */}
          <div className="space-y-1">
            <label className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c7c4d7] ml-1" htmlFor="email">
              Email Address
            </label>
            <div className="relative group">
          ...
          {!isLogin && (
            <div className="space-y-1">
              <label className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c7c4d7] ml-1" htmlFor="phone">
                Phone (Optional)
              </label>
              <div className="relative group">
          ...
          <div className="space-y-1">
            <div className="flex justify-between items-end mb-1">
              <label className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c7c4d7] ml-1" htmlFor="password">
                Password
              </label>
              {isLogin && (
                <a className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c0c1ff] hover:text-[#4edea3] transition-colors" href="#">
                  Forgot password?
                </a>
              )}
            </div>
          ...
          {!isLogin && (
            <div className="space-y-1">
              <label className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c7c4d7] ml-1" htmlFor="confirmPassword">
                Confirm Password
              </label>
              <div className="relative group">
                <Lock className="absolute left-4 top-1/2 -translate-y-1/2 text-[#c7c4d7] group-focus-within:text-[#c0c1ff] transition-colors w-5 h-5" />
          ...
          {!isLogin && (
            <label className="flex items-start gap-2 cursor-pointer">
              ...
              <div className="relative flex-shrink-0 mt-1">
                ...
                {agreedToTerms && (
                  <CircleCheck className="absolute inset-0 text-[#0b1326] w-5 h-5" />
                )}
              </div>
        ...
        <div className="flex items-center justify-center gap-6 pt-8 border-t border-[#ffffff]/5">
          <a className="text-[12px] leading-[16px] tracking-[0.02em] font-medium text-[#c7c4d7] hover:text-[#c0c1ff] transition-colors" href="#">
            Privacy Policy
          </a>
