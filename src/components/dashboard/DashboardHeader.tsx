...
export default function DashboardHeader() {
  return (
    <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6 animate-fade-in">
      <div>
        <h1 className="text-[30px] leading-[38px] tracking-[-0.02em] font-semibold text-[#dae2fd] mb-1">Welcome back, Alex</h1>
        <p className="text-[16px] leading-[24px] tracking-[0em] font-normal text-[#c7c4d7]">
          Your career trajectory is looking strong. 4 new AI-matched roles found today.
        </p>
      </div>
